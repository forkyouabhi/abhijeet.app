  ...
  return (
    <section className="py-24 px-4 relative" id="about">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {/* BENTO GRID */}
        <motion.div 
          className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-12 gap-4 auto-rows-[200px]"
          variants={container}
          initial="hidden"
          whileInView="show"
        ...
        >
          ...
          <motion.div variants={item} className="md:col-span-4 lg:col-span-8 row-span-2">
            <Card className="h-full border border-white/10 glassmorphism relative overflow-hidden group">
              ...
              <CardContent className="h-full flex flex-col justify-center p-8 lg:p-12">
                <Rocket className="w-10 h-10 text-accent mb-6" />
                <h3 className="text-3xl font-bold mb-4">Builder & Problem Solver</h3>
          ...
          <motion.div variants={item} className="md:col-span-2 lg:col-span-4 row-span-1">
            <Card className="h-full border border-white/10 glassmorphism relative overflow-hidden flex flex-col items-center justify-center p-6 bg-gradient-to-br from-background/80 to-muted/80">
              ...
              <h3 className="text-xl font-bold">Greater Toronto Area</h3>
          ...
          <motion.div variants={item} className="md:col-span-2 lg:col-span-4 row-span-1">
            <Card className="h-full border border-white/10 glassmorphism flex flex-col items-center justify-center p-6 group hover:border-accent/50 transition-colors">
              <Terminal className="w-10 h-10 text-muted-foreground group-hover:text-accent transition-colors mb-4" />
              <h3 className="text-2xl font-bold font-mono">1M+</h3>
            ...
            <Card className="h-full border border-white/10 glassmorphism overflow-hidden relative flex flex-col justify-center">
              ...
              <div className="relative flex overflow-x-hidden">
                <div className="animate-marquee whitespace-nowrap flex items-center gap-8 py-2">
                  <span className="text-3xl font-bold text-accent/40 mx-4">PYTHON</span>
                  <span className="text-3xl font-bold text-foreground/20 mx-4">FASTAPI</span>
                  <span className="text-3xl font-bold text-foreground/20 mx-4">SQL</span>
                  <span className="text-3xl font-bold text-foreground/20 mx-4">REACT</span>
                  <span className="text-3xl font-bold text-foreground/20 mx-4">NEXT.JS</span>
                  <span className="text-3xl font-bold text-primary/40 mx-4">TYPESCRIPT</span>
                  <span className="text-3xl font-bold text-foreground/20 mx-4">SUPABASE</span>
                  <span className="text-3xl font-bold text-foreground/20 mx-4">TAILWIND</span>
                  <span className="text-3xl font-bold text-accent/40 mx-4">M365</span>
                </div>
                {/* Duplicate for infinite effect */}
                <div className="absolute top-0 animate-marquee2 whitespace-nowrap flex items-center gap-8 py-2">
                  <span className="text-3xl font-bold text-accent/40 mx-4">PYTHON</span>
                  <span className="text-3xl font-bold text-foreground/20 mx-4">FASTAPI</span>
                  <span className="text-3xl font-bold text-foreground/20 mx-4">SQL</span>
                  <span className="text-3xl font-bold text-foreground/20 mx-4">REACT</span>
          ...
          <motion.div variants={item} className="md:col-span-2 lg:col-span-4 row-span-1">
            <Card className="h-full border border-white/10 glassmorphism p-6 relative overflow-hidden flex flex-col group">
              <h3 className="text-sm font-bold tracking-widest text-muted-foreground uppercase mb-1">Impact</h3>
              <p className="text-xl font-bold mb-4">Supply Chain KPI</p>
